...
export default function BooksPage() {
  ...
  useEffect(() => {
    ...
    const fetchBooks = async () => {
      try {
        const response = await axios.get(`https://book-catalog-backend-red-eight.vercel.app/api/books`, {
          headers: {
  ...
  const toggleFavorite = async (id) => {
    try {
      await axios.post(
        `https://book-catalog-backend-red-eight.vercel.app/api/books/toggle-favorite`,
        { id },
        {
          headers: {
